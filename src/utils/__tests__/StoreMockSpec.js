    ...
    describe('dispatch', () => {
      ...
      describe('getDispatchActions', () => {
        it('uses dispatchMock', () => {
          ...
          spyOn(DispatchMock, 'createMock').and.returnValue({ getActions });
          const store = createMockStore();
      ...
      describe('getDispatchAction', () => {
        it('uses dispatchMock', () => {
          ...
          spyOn(DispatchMock, 'createMock').and.returnValue({ getAction });
          const store = createMockStore();
      ...
      describe('isActionTypeDispatched', () => {
        it('uses dispatchMock', () => {
          ...
          spyOn(DispatchMock, 'createMock').and.returnValue({ isActionTypeDispatched });
          const store = createMockStore();
      ...
      describe('isActionDispatched', () => {
        it('uses dispatchMock', () => {
          ...
          spyOn(DispatchMock, 'createMock').and.returnValue({ isActionDispatched });
          const store = createMockStore();
